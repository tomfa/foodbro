...
export const Chart = () => {
  ...
  const xData = useMemo(
    () => datapoints.map((item) => item[xAxis] / item[yAxis]),
    [xAxis, yAxis],
  );
      ...
      <div className={"my-4 align-"}>
        <span className="isolate inline-flex rounded-md shadow-sm">
          <button
            type="button"
            className={
              "relative inline-flex items-center rounded-l-md px-3 py-2 text-sm font-semibold text-gray-100 ring-1 ring-inset ring-gray-300 focus:z-10 " +
              (header === "Grams protein per kcal"
                ? "bg-green-700"
          ...
          <button
            type="button"
            className={
              "relative -ml-px inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-100 ring-1 ring-inset ring-gray-300 focus:z-10 " +
              (header === "Kcal purchased per kr"
                ? "bg-green-700"
                : "bg-gray-950 hover:bg-gray-800")
            }
            onClick={() => {
          ...
          <button
            type="button"
            className={
              "relative -ml-px inline-flex items-center rounded-r-md px-3 py-2 text-sm font-semibold text-gray-100 ring-1 ring-inset ring-gray-300 focus:z-10 " +
              (header === "Grams protein per kg CO2"
                ? "bg-green-700"
                : "bg-gray-950 hover:bg-gray-800")
            }
            onClick={() => {
